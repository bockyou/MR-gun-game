...
public class ZombieSpawner : MonoBehaviour
{
    ...
    public void SpawnZombie()
    {
        ...
        Vector3 spawnDirection = Quaternion.Euler(0f, randomAngle, 0f) * GameObject.Find("microphone").transform.forward;
        ...
        do
        {
            spawnPosition = GameObject.Find("microphone").transform.position + spawnDirection * spawnRadius + Vector3.up * spawnHeight;
            attempts++;
        } while (Vector3.Distance(spawnPosition, GameObject.Find("microphone").transform.position) < safeRadius && attempts < 10);
